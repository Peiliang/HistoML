...
public class Deduction {
    ...
    public static IRI histoMLIRI = IRI.create("https://histoml-1308125782.cos.ap-chengdu.myqcloud.com/HistoML.owl");
    ...
    public static void main(String[] args) throws Exception {
        ...
        histoML = histoMLManager.loadOntologyFromOntologyDocument(new File("HistoML.owl"));
        manager = OWLManager.createOWLOntologyManager();
        histo = manager.loadOntologyFromOntologyDocument(new File("Histopathology Ontology Simplified.owl"));
        dataFactory = manager.getOWLDataFactory();
        diagnosisClazz = dataFactory.getOWLClass("https://histoml-1308125782.cos.ap-chengdu.myqcloud.com/HistoML.owl#Diagnosis");
        diseaseClazz = dataFactory.getOWLClass("http://www.aipath.com/histo/HISTO_0000003");
        ...
        OWLClass phenotype = dataFactory.getOWLClass("https://histoml-1308125782.cos.ap-chengdu.myqcloud.com/HistoML.owl#Phenotype");
        ...
        OWLClass quantitative = dataFactory.getOWLClass("https://histoml-1308125782.cos.ap-chengdu.myqcloud.com/HistoML.owl#Quantitative_Metric");
    ...
    public static void processDiagnosis(String filename) throws Exception {
        ...
        if (diagnosisResults.isEmpty()) {
            ...
            equivalentList.add(dataFactory.getOWLClass("http://www.aipath.com/histo/histo.owl#Subtyping"));
...
//        manager.saveOntology(merged, format, new FileOutputStream("test.owl"));
        ...
        if (diagnosisResults.isEmpty()) {
            ...
            writeXMLNode(subtyping, diagnosisClazz, true);
